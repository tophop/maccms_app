...
//    static final String getAmeriaList = App_Config.SERVER_PATH+"public/?service=App.Mov.GetOnlineList";
    /**
     * 获取影片分类列表
     */
...
//    public static ArrayList<VideoTypeVo.ClassBean> curtoon;
    public static ArrayList<VideoTypeVo.ClassBean> koria;
    public static ArrayList<VideoTypeVo.ClassBean> america;
}
