...
public class CategoryActivity extends AppCompatActivity {
    ...
    private void initData() {
         ...
         * 类型是根据主tab动态改变的
         */
        ArrayList<VideoTypeVo.ClassBean> america = UrlConfig.america;
        VideoTypeVo.ClassBean bean = new VideoTypeVo.ClassBean();
        bean.setType_id(0);
        bean.setType_name("全部类别");
        america.add(0, bean);

        ArrayList<VideoTypeVo.ClassBean> koria = UrlConfig.koria;
        VideoTypeVo.ClassBean seriBean = new VideoTypeVo.ClassBean();
        seriBean.setType_id(0);
        seriBean.setType_name("全部类别");
        koria.add(0, seriBean);

        movTabAdapter = new CateTabAdapter2(america, (position, content) -> {
        ...
        CateTabAdapter mainTabAdapter = new CateTabAdapter(mainTab, (position, content) -> {
            ...
            switch (position) {
                ...
                case 1:
                    ...
                    areaCatTab.setVisibility(View.VISIBLE);
                    CategoryActivity.this.movTabAdapter.setData(america);
                    requestTypeId = 21;
                    typeContent="美剧";
                    break;
                case 2:
                    ...
                    typeCatTab.setVisibility(View.VISIBLE);
                    areaCatTab.setVisibility(View.VISIBLE);
                    CategoryActivity.this.movTabAdapter.setData(koria);
                    typeContent="韩剧";
                    requestTypeId = 20;
                    break;
//                case 3:
