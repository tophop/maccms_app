...
public class HomeMainFragment extends Fragment {
    ...
    private void initview() {
        ...
        ArrayList<VideoTypeVo.ClassBean> america = new ArrayList<>(); //电影
        ArrayList<VideoTypeVo.ClassBean> koria = new ArrayList<>();  //电视剧
       ...
       /* ArrayList<VideoTypeVo.ClassBean> show = new ArrayList<>();*/
        ...
        for (VideoTypeVo.ClassBean classInfo : typeVo.getClassInfo()) {
            ...
            if (classInfo.getType_name().startsWith("美剧")) {
                america.add(classInfo);
                UrlConfig.america = america;
            }
            if (classInfo.getType_name().startsWith("韩剧")) {
                koria.add(classInfo);
                UrlConfig.koria = koria;
            }
...
*/
        ...
        MovieRootFragment movieTabRoot = MovieRootFragment.newInstance(america);
        MovieRootFragment seriTabRoot = MovieRootFragment.newInstance(koria);
